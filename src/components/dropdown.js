...
class Dropdown extends Component {
  ...
  render() {
    ...
    if (this.props.isOrange === true) {
      const controlClass = classNames({
        [`${baseClassName}-control-orange`]: true,
        [controlClassName]: !!controlClassName,
        [disabledClass]: !!disabledClass,
      });
    } else {
      const controlClass = classNames({
        [`${baseClassName}-control-teal`]: true,
        [controlClassName]: !!controlClassName,
        [disabledClass]: !!disabledClass,
      });
    }
    ...
    return (
      <div className={dropdownClass} style={{width:this.props.width}}>
        <div
          className={
            this.props.isOrange
              ? "Dropdown-control-orange"
              : "Dropdown-control-teal"
          }
